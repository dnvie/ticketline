...
public class MessageEndpointTest implements TestData {
    ...
    public void givenNothing_whenFindAll_thenEmptyList() throws Exception {
        ...
        MessagesWithCountDto messagesWithCountDto = objectMapper.readValue(response.getContentAsString(),
            MessagesWithCountDto.class);
        List<SimpleMessageDto> simpleMessageDtos = messagesWithCountDto.getMessages();
